...
describe('app-pi', function() {
  ...
  beforeEach(function() {
    ...
    this.discoverPlugs = sinon.stub().resolves();
    ...
    this.app = app({
      ...
      discoverPlugs: this.discoverPlugs,
    ...
    describe('/action', function() {
      ...
      describe('POST /', function() {
        ...
        context('with valid API token', function() {
          ...
          describe('action: discover', function() {
            ...
            it('responds with 201 and triggers config.discoverPlugs', function(done) {
              request(this.app)
                .post('/plugs/action')
                .send(this.action)
                .set(this.headers)
                .expect(201)
                .expect('Content-Type', 'application/json; charset=utf-8')
                .expect(res => expect(this.discoverPlugs).to.be.called)
                .end(done);
            });
          });
