...
module.exports = function(config) {
  ...
  if (config.value) {
    return function(deviceId) {
      logger.info(`Turning on irrigation for ${deviceId}`);
      return Promise.all([
